...
document.addEventListener('DOMContentLoaded', () => {
        ...
        if (combustibleVehiculo) {
            switch(combustibleVehiculo.value) {
                case 'gasolina': factorCombustible = 2.37; break;
                case 'diesel': factorCombustible =2.77 ; break;
                case 'hibrido_no': factorCombustible = 1.82 ; break;
                case 'electrico': factorCombustible = 0.3; break;
        ...
        if (transportePublico) {
            switch(transportePublico.value) {
                case '2dias': factorTransportePublico =0 ; break;
                case '3_4dias': factorTransportePublico =0 ; break;
                case '5_6dias': factorTransportePublico = 0; break;
                case 'no_uso_trasporte_publico': factorTransportePublico = 0; break;
            }
        }
        ...
        if (dieta) {
            switch(dieta.value) {
                case 'equilibrada': factorDieta =0 ; break;
                case 'carnes_rojas': factorDieta =0 ; break;
                case 'pescetariana': factorDieta =0 ; break;
                case 'vegetariana': factorDieta =0 ; break;
                case 'vegana': factorDieta =0 ; break;
            }
        }
        ...
        if (origenComida) {
            switch(origenComida.value) {
                case 'origen_local': factorOrigenComida =0 ; break;
                case 'envasados_procesados': factorOrigenComida =0; break;
                case 'no_me_importa': factorOrigenComida =0 ; break;
            }
        }
        ...
        if (comidaSobrante) {
            switch(comidaSobrante.value) {
                case 'aprovecho': factorComidaSobrante =0 ; break;
                case 'tiro_algo': factorComidaSobrante =0 ; break;
                case 'no_importa_desperdicio': factorComidaSobrante =0 ; break;
            }
        }
        // Huella anual alimentación (ejemplo suma simple)
        const huellaAlimentacion = factorDieta + factorOrigenComida + factorComidaSobrante;
        ...
        if (ropaNueva) {
            switch(ropaNueva.value) {
                case 'varias_veces': factorRopaNueva =0 ; break;
                case 'una_cada_dos': factorRopaNueva =0 ; break;
                case 'poco_al_año': factorRopaNueva =0 ; break;
                case 'nunca_segunda_mano': factorRopaNueva =0; break;
            }
        }
        ...
        if (dispElectronicos) {
            switch(dispElectronicos.value) {
                case 'uno_dos_año': factorDispElectronicos =0 ; break;
                case 'tres_cuatro_año': factorDispElectronicos =0 ; break;
                case 'cuatro_año': factorDispElectronicos =0 ; break;
            }
        }
        ...
        if (donasVendes) {
            switch(donasVendes.value) {
                case 'frecuente_dono': factorDonasVendes =0 ; break;
                case 'aveces_dono': factorDonasVendes =0 ; break;
                case 'tiro_regalo': factorDonasVendes =0 ; break;
            }
        }
        // Huella anual consumo
        const huellaConsumo = factorRopaNueva + factorDispElectronicos + factorDonasVendes;
        ...
        if (reciclas) {
            switch(reciclas.value) {
                case 'siempre': factorReciclas =0 ; break;
                case 'aveces': factorReciclas =0; break;
                case 'casi_nunca': factorReciclas =0; break;
            }
        }
        ...
        if (basuraGenerada) {
            switch(basuraGenerada.value) {
                case 'muy_poca': factorBasuraGenerada =0 ;break;
                case 'moderada': factorBasuraGenerada =0 ; break;
                case 'bastante': factorBasuraGenerada =0 ; break;
            }
        }
        ...
        const huellaResiduos = factorReciclas + factorBasuraGenerada + (bolsasBasura * factorBolsasBasura);

        // Suma total huella anual
        const huellaTotal = huellaEnergia + huellaCalefaccion + huellaAire + huellaVehiculo + huellaTransportePublico + huellaVuelos + huellaAlimentacion + huellaConsumo + huellaResiduos;

        alert('Tu huella de carbono estimada anual es: ' + huellaTotal.toFixed(2) + ' kg CO2e');
    });
});